...
const MobileMenu: React.FC<MenuType> = ({ links, atTop }) => {
    ...
    return (
        <div className="block md:hidden">
            ...
            <div className={`${isActive ? "h-56 py-4" : "h-0"} md:hidden flex flex-col gap-3 absolute w-full left-0 top-[73px] bg-[#ffffff] transition-all duration-500 overflow-auto`}>
                {
