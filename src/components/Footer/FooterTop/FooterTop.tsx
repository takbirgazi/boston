...
const FooterTop = () => {
    return (
        <div className='bg-[#179510] py-14 md:py-16 px-10'>
            <div className='container mx-auto max-w-[1200px] px-4 flex flex-col md:flex-row gap-8 md:gap-20 justify-between'>
                <div className='w-full md:w-1/2 flex justify-end'>
                    <div className='w-full md:w-sm'>
                        <div className='flex pb-3'>
                            <p className='px-3 py-1 bg-[#168e13] rounded-sm font-bold text-white'>Call us for further information</p>
                        </div>
                ...
                <div className='w-full md:w-1/2'>
                    <div className='w-full md:w-sm h-full flex gap-3 flex-col md:items-center md:justify-center '>
                        ...
                        <div>
                            <button className="px-5 py-1.5 rounded-sm bg-[#1ecb15] text-white font-semibold cursor-pointer">Contact Us</button>
                        </div>
                    </div>
                </div>
            </div>
